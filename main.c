		...
		SubWindow, (IPTR) cn->Window = WindowObject,
			...
			WindowContents, 
				VGroup,
					Child, HGroup, 
						MUIA_Weight, 25,
						Child, cn->LV_STATUS = NListviewObject, 
					...
					Child, HGroup,
						MUIA_Weight, 53,
						Child, VGroup,
							Child, cn->S_LEFT_VIEW_PATH = (APTR) StringObject, StringFrame, MUIA_CycleChain, 1, MUIA_String_MaxLen, 512, End,
							
							Child, cn->lv.ListView = NListviewObject,
						...
						Child, VGroup,
							...
							Child, cn->rv.ListView = NListviewObject, 
								MUIA_NListview_NList, NListObject,
									MUIA_CycleChain, 1, 
									MUIA_NList_Format, "MAXW=50,MAXW=20,MAXW=20,MAXW=10",
									MUIA_NList_TypeSelect, MUIV_NList_TypeSelect_Line,
					...
					Child, VGroup,
						...
						Child, cn->QueueLV = NListviewObject, 
							MUIA_NListview_NList, NListObject,
							MUIA_CycleChain, 1, 
...
//			MUIA_Window_Height, MUIV_Window_Height_MinMax(20),
			...
			WindowContents,
				VGroup, 
					Child, HGroup, 
						Child, g_AddressBook.LV_HOSTS = NListviewObject, 
								MUIA_Listview_List, NListObject,
									MUIA_CycleChain, 1, 
									ReadListFrame,
									MUIA_List_AutoVisible, TRUE,
					...
					Child, HGroup, 
		    			Child, VGroup,
							...
							Child, HGroup,
								MUIA_Weight, 70,
    							Child, g_AddressBook.S_ENTRYNAME = (APTR) StringObject, MUIA_CycleChain, 1, StringFrame, MUIA_String_MaxLen, 128, End,
    						End,
							...
							Child, HGroup, 
								Child, HGroup,
									MUIA_Weight, 70,
		    						Child, g_AddressBook.S_HOSTNAME	 = (APTR) StringObject, MUIA_CycleChain, 1, StringFrame, MUIA_String_MaxLen, 128, End,
		    					End,
			    				Child, HGroup,
			    					MUIA_Weight, 20,
									Child, g_AddressBook.S_PORT		 = (APTR) StringObject, MUIA_CycleChain, 1, StringFrame, MUIA_String_MaxLen, 8, End,
								End,
			    			End, 
							
							Child, TextObject, MUIA_Text_Contents, "Username", End,
	    					Child, g_AddressBook.S_USERNAME  = (APTR) StringObject, MUIA_CycleChain, 1,StringFrame, MUIA_String_MaxLen, 32, End,
    						Child, TextObject, MUIA_Text_Contents, "Password", End,
	    					Child, g_AddressBook.S_PASSWORD  = (APTR) StringObject, MUIA_CycleChain, 1,StringFrame, MUIA_String_MaxLen, 32, End,
		    			End,	
					End,
    				...
    				Child, HGroup,
    					Child, VGroup,
    						...
    						Child, g_AddressBook.RDIO_CONN_TYPE = RadioObject,
					...
					Child, HGroup, 
						Child, g_AddressBook.BTN_NEW = HGroup,
							ButtonFrame,
							MUIA_InputMode, MUIV_InputMode_RelVerify,
							MUIA_Background, MUII_ButtonBack,
						...
						Child, g_AddressBook.BTN_EXIT = HGroup,
							ButtonFrame,
							MUIA_InputMode, MUIV_InputMode_RelVerify,
							MUIA_Background, MUII_ButtonBack,
		...
		SubWindow, g_AddressBook.Window_HostsFull = WindowObject,
			...
			WindowContents,
				VGroup, 
					...
					Child, g_AddressBook.BTN_HostsFullOk = HGroup,
						ButtonFrame,
						MUIA_InputMode, MUIV_InputMode_RelVerify,
						MUIA_Background, MUII_ButtonBack,
						Child, TextObject, MUIA_CycleChain, 1, MUIA_Text_Contents, "\33c Exit", End,
		...
		SubWindow, g_GlobalSettings.Window = WindowObject,
			...
			WindowContents,
				VGroup, 
					...
					Child, g_GlobalSettings.S_TRANSFER_SOCKET_TIMEOUT = StringObject, 
											StringFrame, MUIA_String_MaxLen, 3, End,
					
					Child, TextObject, MUIA_Text_Contents, "\33cConnection Timeout", End,
					Child, g_GlobalSettings.S_CONNECTION_SOCKET_TIMEOUT = StringObject, 
											StringFrame, MUIA_String_MaxLen, 3, End,
					...
					Child, HGroup,
						Child, g_GlobalSettings.BTN_SAVE = HGroup,
							ButtonFrame,
							MUIA_InputMode, MUIV_InputMode_RelVerify,
							MUIA_Background, MUII_ButtonBack,
							Child, TextObject, MUIA_CycleChain, 1, MUIA_Text_Contents, "\33c Save", End,
						...
						Child, g_GlobalSettings.BTN_CANCEL = HGroup,
							ButtonFrame,
							MUIA_InputMode, MUIV_InputMode_RelVerify,
							MUIA_Background, MUII_ButtonBack,
